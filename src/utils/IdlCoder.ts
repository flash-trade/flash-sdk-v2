        ...
        if ("vec" in (field.type as object)) {
          return borsh.vec(
            IdlCoder.fieldLayout(
              { name: undefined, type: (field.type as any).vec },
              types
            ),
            fieldName
          );
          ...
          return borsh.option(
            IdlCoder.fieldLayout(
              { name: undefined, type: (field.type as any).option },
              types
            ),
            fieldName
          );
          ...
          const defined =
            typeof definedType === "string" ? definedType : definedType.name;
          if (types === undefined) {
          ...
          const arrayTy = (field.type as any).array[0];
          const arrayLen = (field.type as any).array[1] as number;
          const innerLayout = IdlCoder.fieldLayout(
            { name: undefined, type: arrayTy },
            types
          );
